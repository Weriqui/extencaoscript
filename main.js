const mapa_json = {
  ...
  "ca0522645a122680e27d6b12211515a7d4de3c71":"repesca-1",
  "22611d8612b7295bb8f056dc9ffa9de1185526ba":"repesca-2",
  "6640d948df104e6704fa66b0661cc04b7ebc53d7":"repesca-3",
  "7454d15b1c318fc0ce472463054a29c2a0f5e46b":"repesca-4",
  "f26d73d365ca0be6f28b05fa578adb210b80b386":"repesca-5",
  "04ba2b31329100a900ae73cac27ad85a15f1a5e6":"repesca-6",
  "a5c76025bf4b0c1a9e18f45f873e805c99fedc43":"repesca-7"
}
...
waitForElement("#consulta", (element) => {
    ...
    (function() {
        ...
        async function fetchProductData(productNumber,etapa) {
          ...
          try {
            const response = await fetch(`https://api.pipedrive.com/v1/products/${productNumber}?api_token=049fc9691e98bcb47e9815bc5c54be0486c289de`, requestOptions);
...
async function pesquisaTelefone(telefone) {
  let apiToken = "049fc9691e98bcb47e9815bc5c54be0486c289de"
  const myHeaders = new Headers();
  myHeaders.append("Accept", "application/json");
...
async function busca_produto(tipo_produto=false){
  ...
  const response = await fetch(`https://api.pipedrive.com/v1/products?filter_id=${filtro_especifico}&api_token=049fc9691e98bcb47e9815bc5c54be0486c289de`, requestOptions)
  const result = await response.json()
  const data = await result.data
  let option = '<option value="">Selecione</option>\n '
  for(produto of data){
